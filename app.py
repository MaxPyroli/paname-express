...
def afficher_live_content(stop_id, clean_name):
    ...
    if now.month == 4 and now.day == 1:
        ...
        # Le code HTML/CSS AVEC retour à la ligne pour Mobile (CSS compressé inclus)
        html_poisson = f"""<style>@media(max-width: 480px){{.ch-row{{flex-direction:column !important;align-items:flex-start !important;}}.ch-times{{width:100% !important;text-align:left !important;margin-top:6px !important;}}}}</style><div style="margin-top: 10px; margin-bottom: 20px;"><div style="background-color: #041b3b; height: 54px; width: 100%; border-radius: 12px; box-sizing: border-box;"></div><div style="margin-top: -54px; height: 54px; width: 100%; box-sizing: border-box; background: rgba(255, 255, 255, 0.08); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border-radius: 12px; border: 1px solid rgba(255, 255, 255, 0.15); display: flex; align-items: center; padding: 0 16px; gap: 12px; color: #ffffff; font-size: 1.15rem; font-weight: 800; letter-spacing: 0.5px; margin-bottom: 15px;">🐴 CHEVAL</div><div class="rail-card" style="border-left-color: #ff5500 !important; background-color: #041b3b; padding: 12px; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.3);"><div style="display: flex; align-items: center; margin-bottom: 8px;"><span class="line-badge" style="background-color: #ff5500; font-size: 16px; padding: 4px 10px; margin-right: 10px; border-radius: 6px;">CH</span><span style="background-color: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.2); border-radius: 6px; padding: 2px 6px; font-size: 14px;">🚧</span></div><div style="color: #f39c12; font-size: 0.85em; margin-bottom: 15px; font-weight: 500; border-left: 2px solid #f39c12; padding-left: 8px; font-style: italic;">⚠️ Mouvement social : Grève surprise des juments. Des retards sont à prévoir sur l'ensemble du réseau équestre. Prévoyez des carottes.</div><div class="rail-row ch-row" style="border-top: 1px solid rgba(255, 255, 255, 0.1) !important; padding-top: 8px; margin-top: 8px;"><span class="rail-dest" style="color: #e0e0e0; font-weight: 500; white-space: normal !important; overflow: visible !important;">➔ {d1}</span><span class="ch-times" style="white-space: nowrap; text-align: right;"><span style="color: #f39c12; font-weight: bold;">{t1_1}</span> <span style="color: #888; margin: 0 6px; font-weight: lighter;">|</span> <span style="color: #2ecc71; font-weight: bold;">{t1_2}</span> <span style="color: #888; margin: 0 6px; font-weight: lighter;">|</span> <span style="color: #2ecc71; font-weight: bold;">{t1_3}</span></span></div><div class="rail-row ch-row" style="border-top: 1px solid rgba(255, 255, 255, 0.1) !important; padding-top: 8px; margin-top: 8px;"><span class="rail-dest" style="color: #e0e0e0; font-weight: 500; white-space: normal !important; overflow: visible !important;">➔ {d2}</span><span class="ch-times" style="white-space: nowrap; text-align: right;"><span style="color: #2ecc71; font-weight: bold;">{t2_1}</span> <span style="color: #888; margin: 0 6px; font-weight: lighter;">|</span> <span style="color: #2ecc71; font-weight: bold;">{t2_2}</span> <span style="color: #888; margin: 0 6px; font-weight: lighter;">|</span> <span style="color: #2ecc71; font-weight: bold;">{t2_3}</span></span></div><div class="rail-row ch-row" style="border-top: 1px solid rgba(255, 255, 255, 0.1) !important; padding-top: 8px; margin-top: 8px;"><span class="rail-dest" style="color: #e0e0e0; font-weight: 500; white-space: normal !important; overflow: visible !important;">➔ {d3}</span><span class="ch-times" style="white-space: nowrap; text-align: right;"><del style="color: #888;">{t3} min</del> &nbsp;<span style="color: #e74c3c; font-weight: bold; font-style: italic;">Cheval enfui</span></span></div></div></div>"""        
