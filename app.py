...
<style>
    ...
    .section-header {
        ...
        border-bottom: 2px solid rgba(128, 128, 128, 0.5); font-size: 20px; font-weight: bold; color: var(--text-color); letter-spacing: 1px;
    }
    .station-title {
...
# Définition des axes et des scores pour le positionnement géographique
...
st.caption("v0.11alpha - Milk • ⚠️ Pre-release")
