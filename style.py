...
def appliquer_style_global():
    ...
    <style>
        ...
        /* 🛡️ CORRECTION Z-INDEX : Force les cartes avec un menu trafic ouvert à passer devant les autres cartes, mais sous les titres de navigation */
        ...
        .bus-card:has(details.traffic-icon[open]) {
            ...
            z-index: 999 !important; /* Assez haut pour les cartes, mais sous 1050 (titres) */
        }
